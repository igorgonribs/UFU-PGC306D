...
trials_df, best_hist_df = run_hparam_search(n_trials=25, n_epochs=40, output_prefix="experimento_02_")
trials_df.head()
...
plt.tight_layout()
filename=GRAPH_DIR+'/experimento_02_curvas_loss.png'
...
plt.tight_layout()
filename=GRAPH_DIR+'/experimento_02_curvas_acuracia.png'
plt.savefig(filename, dpi=150)
plt.show()
...
output_prefix = "experimento_02_" # Certifique-se que este prefixo corresponde ao usado em run_hparam_search
